...
import { Modal, Navbar, Popover, OverlayTrigger, Button, Form } from 'react-bootstrap'
        ...
        return (
            <div style={{ marginBottom: '70px' }}>
                <Navbar collapseOnSelect expand="lg" bg="primary" variant="dark" fixed="top">
                    <Navbar.Brand style={{ marginLeft: '20px' }}>Teacher's Portal</Navbar.Brand>
                    <Navbar.Toggle />
                    <Navbar.Collapse className="justify-content-end">
                        <Navbar.Text style={{ marginRight: '15px', color: 'white' }}>
                            Signed in as: <OverlayTrigger trigger="click" placement="bottom" overlay={popover}>
                                <strong style={{ cursor: 'pointer' }}>{this.props.teacherName}</strong>
                            </OverlayTrigger>
                        </Navbar.Text>
